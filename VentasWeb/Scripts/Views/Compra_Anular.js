        ...
        "columns": [
            {
                "data": "IdCompra", render: function (data) {
                    return "<button class='btn btn-danger btn-sm ml-2' type='button' onclick='AnularCompra(" + data + ")'><i class='fas fa-ban'></i>Anular</button> <button class='btn btn-success btn-sm ml-2' type='button' onclick='Imprimir(" + data + ")'><i class='far fa-clipboard'></i> Ver</button>"
                }
            },
            { "data": "NumeroCompra" },
            {
