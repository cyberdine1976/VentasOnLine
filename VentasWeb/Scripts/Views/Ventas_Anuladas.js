...
$(document).ready(function () {
    ...
    tabladata = $('#tbVentasAnuladas').DataTable({
        "ajax": {
            "url": $.MisUrls.url._ObtenerVentasAnuladas + "?codigo=&fechainicio=" + ObtenerFecha() + "&fechafin=" + ObtenerFecha() + "&numerodocumento=&nombres=",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...
function buscar() {
    ...
    tabladata.ajax.url($.MisUrls.url._ObtenerVentasAnuladas + "?" +
