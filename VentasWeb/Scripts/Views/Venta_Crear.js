...
$(document).ready(function () {
    ...
    tablacliente = $('#tbcliente').DataTable({
        "ajax": {
            "url": $.MisUrls.url._ObtenerClientesActivos,
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
...
$('#btnAgregar').on('click', function () {
    ...
    var stock = $("#txtproductostock").val();

    if (cantidad > stock) {
        swal("Mensaje", "La Cantidad solicitada no debe ser mayor al Stock de Productos", "warning")
        return;
    }
