...
namespace VentasWeb.Controllers
{
    public class VentaController : Controller
    {
        ...
        public JsonResult ObtenerAnuladas(string codigo, string fechainicio, string fechafin, string numerodocumento, string nombres)
        {
            List<Venta> lista = CD_Venta.Instancia.ObtenerListaVentasAnuladas(codigo, Convert.ToDateTime(fechainicio), Convert.ToDateTime(fechafin), numerodocumento, nombres);
        ...
        [HttpGet]
        public JsonResult AnularFactura(int id =0)
        {
            bool respuesta = CD_Venta.Instancia.AnularVenta(id);
