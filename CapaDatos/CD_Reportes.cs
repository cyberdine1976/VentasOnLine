...
namespace CapaDatos
{
    public class CD_Reportes
    {
        ...
        public List<ReporteProducto> ReporteProductoTienda(int IdTienda, string CodigoProducto)
        {
            ...
            NumberFormatInfo formato = new CultureInfo("en-IN").NumberFormat;
                    ...
                    using (SqlDataReader dr = cmd.ExecuteReader()) {
                        while (dr.Read()) {
                            lista.Add(new ReporteProducto()
                            {
                                ...
                                PrecioCompra = Convert.ToDecimal(dr["Precio Compra"].ToString(),new CultureInfo("en-IN")).ToString("N", formato),
                                PrecioVenta = Convert.ToDecimal(dr["Precio Venta"].ToString(),new CultureInfo("en-IN")).ToString("N", formato)
                            });
                        }
